...
const { createInvoice } = require("./crearpdfcarta.js");
const filename = Math.random() + 'Carta' + '.pdf';
router.get('/', (req, res) => {
...
router.post('/pdf', function (req, res) {
  ...
  const { id } = req.params
  connection.query("select * from carta WHERE id = ? ", [req.body.invoice_id], function (err, result) {
    if (err) throw err;
    ...
    //createInvoice(invoice, "CartaT.pdf");
