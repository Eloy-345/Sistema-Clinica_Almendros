...
function generateHeader(doc) {
  doc
    .image("fondo.png", 35, 40, { width: 100 })
...
function generateCustomerInformation(doc, invoice) {
  doc
    .fontSize(14)
    .text("CLINICA ALMENDROS", 50, 120, { align: "left" })
    .fontSize(12)
    .text("Dr. Ulises Pérez Montesinos", 50, 135, { align: "left" });
  ...
  doc
    ...
    .font('Helvetica', 12)
    .text("Dr. Ulises Pérez Montesinos", 95, customerInformationTop + 110)
    .font('Helvetica', 12)
    .text("me ha explicado que es", 260, customerInformationTop + 110)
    .font('Helvetica', 12)
