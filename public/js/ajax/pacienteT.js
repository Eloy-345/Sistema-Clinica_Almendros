$(function () {
    ...
    $('#insertar').on('click', function () {
        ...
        $.ajax({
            ...
            $('#cerrar').click()
            window.location.href = '/pacienteT'
        })
...
/*    $('table').on('click', '#update', function () {
    ...
    $('table').on('click', '#detalle1', function () {
        ...
        <div class="text-left">
                        ...
                        <div class="row g-3 " " style="text-align: justify;">
                            <div class="col-sm-4">
                            <label for="nombre" class="form-label"> Padre con:</label>
                        ...
                        <div class="row g-3 " " style="text-align: justify;">
                            <div class="col-sm-4">
                                <label for="nombre" class="form-label">DM: </label>
                        ...
                        <div class="row g-3  "style="text-align: justify;">
                            <div class="col-sm-4">
                                <label for="nombre" class="form-label">HAS: </label>
                        ...
                        <div div class="row g-3" style="text-align: justify;">
                            ...
                            <div class="row g-3 ">
                                ...
                                <div class="col-sm-6">
                                <label for="nombre" class="form-label">Parás:</label>
    ...
    $('table').on('click', '#detalle2', function () {
        ...
        $.ajax({
            ...
            <tr>
                <td>
                    <h5 style="font-size: large;" class="text-justificado"></h5>
                </td>
            </tr>
            <tr>
                <td>
                    <h5 class="texto-justificado">Dr. Ulises Pérez Montesinos</h5>
                </td>
            </tr>
        </table>
        <br>
        <div class="text-center">
            ...
            <div class="col-md-7 col-lg-10">
                            ...
                            <div style="font-size: 15px; text-align: justify;">
                                Que el <input  type="text" name="esp1" id="esp1" class="col-sm-5" value="Dr. Ulises Pérez Montesinos">, me ha explicado que
                            ...
                            <div class="text-justificado row g-3 ">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="esp10" name="esp10" placeholder=""
                                        value="Dr. Ulises Pérez Montesinos">
                                </div>
                                <div class="col-sm-6">
